...
Please find an example report from the tool in the repo! This report was generated by running hAPI agains the (Full Stack FastAPI Template)[https://github.com/fastapi/full-stack-fastapi-template]
